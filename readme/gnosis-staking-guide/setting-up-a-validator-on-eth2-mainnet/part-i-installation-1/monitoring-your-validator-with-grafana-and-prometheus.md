...
{% tab title="Nimbus" %}
![Dashboard by status-im](../../../ethereum-staking-guide/.gitbook/assets/nim\_dashboard.png)
...
{% tab title="Prysm" %}
![Prysm dashboard by GuillaumeMiralles](../../../ethereum-staking-guide/.gitbook/assets/prysm\_dash.png)
...
![](<../../../ethereum-staking-guide/.gitbook/assets/grafana (1).png>)
