...
If you need to install Metamask, [refer to this.](https://docs.featured.market/featured-by-binance/how-to-guides/getting-started/how-to-download-metamask/)
...
{% hint style="info" %}
For a video demo, watch [MohamedMansour's eth2 education videos](https://www.youtube.com/watch?v=txgOVDTemPQ).
{% endhint %}
...
[Review section 6](../../nodes/ethereum-node/guide-or-how-to-setup-a-validator-on-eth2-testnet.md#6-monitoring-your-validator-with-grafana-and-prometheus) and change your `prometheus.yml`. Ensure prometheus is connected to your new eth2 client's metrics port. You will also want to import your new eth2 client's dashboard.
...
{% tabs %}
{% tab title="NodeBridge Africa" %}
{% embed url="https://discord.gg/96VeDVSw" %}
{% endtab %}
